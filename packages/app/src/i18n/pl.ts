export const dict = {
  ...
  "dialog.provider.physicscode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.physicscode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.physicscodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez PhysicsCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w PhysicsCode.",
  ...
  "provider.connect.physicscodeZen.line1":
    "PhysicsCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.physicscodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.physicscodeZen.visit.link": "physicscode.ai/zen",
  "provider.connect.physicscodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w PhysicsCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w PhysicsCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w physicscode.json",
  ...
  "dialog.server.description": "Przełącz serwer PhysicsCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja PhysicsCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu PhysicsCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (physicscode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "PhysicsCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla PhysicsCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd PhysicsCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy PhysicsCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw PhysicsCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania PhysicsCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji PhysicsCode.",
