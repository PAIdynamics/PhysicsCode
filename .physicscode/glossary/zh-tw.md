...
- PR #13942: https://github.com/anomalyco/physicscode/pull/13942

## Do Not Translate (Locale Additions)

- `PhysicsCode` (preserve casing in prose; keep `physicscode` only when it is part of commands, package names, paths, or code)
- `PhysicsCode Zen`
- `PhysicsCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `physicscode` in prose when referring to the product name; use `PhysicsCode`
