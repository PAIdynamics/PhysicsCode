...
Crear `.physicscode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración PhysicsCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su PhysicsCode [config](/docs/config):
...
- Por proyecto: `.physicscode/commands/`
...
physicscode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
