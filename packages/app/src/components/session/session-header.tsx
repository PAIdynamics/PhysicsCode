import { AppIcon } from "@physicscode-ai/ui/app-icon"
...
import { Keybind } from "@physicscode-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_PHYSICSCODE_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("physicscode-titlebar-center"))
    setRightMount(document.getElementById("physicscode-titlebar-right"))
  })
