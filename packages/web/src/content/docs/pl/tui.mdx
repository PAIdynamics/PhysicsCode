---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala physicscode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

physicscode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie physicscode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI physicscode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do physicscode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij physicscode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `physicscode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `PHYSICSCODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
