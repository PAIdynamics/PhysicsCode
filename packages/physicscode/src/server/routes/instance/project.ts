  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of projects that have been opened with PhysicsCode.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the currently active project that PhysicsCode is working with.",
