...
`.physicscode/commands/test.md` oluştur:
...
physicscode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

physicscode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/physicscode/commands/`
- Proje başına: `.physicscode/commands/`
...
physicscode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
