...
import compareVideo from "../../asset/lander/physicscode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/physicscode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="physicscode:auth" content={loggedin() ? "true" : "false"} />
