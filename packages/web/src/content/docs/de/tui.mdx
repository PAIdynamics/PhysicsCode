---
title: TUI
description: Arbeite mit PhysicsCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PhysicsCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet PhysicsCode die TUI im aktuellen Verzeichnis.
...
In der PhysicsCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu PhysicsCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet PhysicsCode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `physicscode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `PHYSICSCODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
