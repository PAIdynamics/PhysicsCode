...
Brug den til at bygge integrasjoner og kontrollere physicscode programmatisk.
...
Opret en forekomst av physicscode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `physicscode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av physicscode, kan du oprete en klientforekomst for at koble til den:
