...
const FILES = [
  "AGENTS.md",
  ...(Flag.PHYSICSCODE_DISABLE_CLAUDE_CODE_PROMPT ? [] : ["CLAUDE.md"]),
...
export class Service extends Context.Service<Service, Interface>()("@physicscode/Instruction") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const globalFiles = [
      ...
      ...(!Flag.PHYSICSCODE_DISABLE_CLAUDE_CODE_PROMPT ? [path.join(global.home, ".claude", "CLAUDE.md")] : []),
    ]
