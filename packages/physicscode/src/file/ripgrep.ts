...
import { sanitizedProcessEnv } from "@physicscode-ai/core/util/physicscode-process"
...
export class Service extends Context.Service<Service, Interface>()("@physicscode/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".physicscode")) continue
