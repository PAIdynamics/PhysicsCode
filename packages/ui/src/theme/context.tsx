...
const STORAGE_KEYS = {
  THEME_ID: "physicscode-theme-id",
  COLOR_SCHEME: "physicscode-color-scheme",
  THEME_CSS_LIGHT: "physicscode-theme-css-light",
  THEME_CSS_DARK: "physicscode-theme-css-dark",
} as const
