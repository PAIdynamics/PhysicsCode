export const dict = {
  ...
  "dialog.provider.physicscode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.physicscode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.physicscodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje PhysicsCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u PhysicsCode-u.",
  ...
  "provider.connect.physicscodeZen.line1":
    "PhysicsCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.physicscodeZen.visit.prefix": "Posjeti ",
  "provider.connect.physicscodeZen.visit.link": "physicscode.ai/zen",
  "provider.connect.physicscodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u PhysicsCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u PhysicsCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u physicscode.json",
  ...
  "dialog.server.description": "Promijeni na koji se PhysicsCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija PhysicsCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku PhysicsCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (physicscode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: PhysicsCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "PhysicsCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni PhysicsCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u PhysicsCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako PhysicsCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li PhysicsCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu PhysicsCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se PhysicsCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju PhysicsCode-a.",
