...
const releaseId = process.env.PHYSICSCODE_RELEASE
if (!releaseId) throw new Error("PHYSICSCODE_RELEASE is required")

const version = process.env.PHYSICSCODE_VERSION
if (!version) throw new Error("PHYSICSCODE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "physicscode-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "physicscode-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "physicscode-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "physicscode-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "physicscode-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "physicscode-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "physicscode-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "physicscode-desktop-darwin-aarch64.app.tar.gz",
  },
]
