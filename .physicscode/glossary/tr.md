...
- PR #15835: https://github.com/anomalyco/physicscode/pull/15835

## Do Not Translate (Locale Additions)

- `PhysicsCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `physicscode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `PhysicsCode` in prose, `physicscode` only for exact technical identifiers
...
- Avoid changing `physicscode` to `PhysicsCode` inside commands, URLs, package names, or code literals
