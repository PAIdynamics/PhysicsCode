---
title: TUI
description: Usando a interface de usuário de terminal physicscode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O physicscode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar physicscode inicia o TUI para o diretório atual.
...
Ao usar o TUI do physicscode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao physicscode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do physicscode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `physicscode.json`, que configura o comportamento do servidor/runtime.
...
Use `PHYSICSCODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
