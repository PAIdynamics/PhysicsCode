...
Kreiraj `.physicscode/commands/test.md`:
...
Možete dodati prilagođene komande kroz PhysicsCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom PhysicsCode [config](/docs/config):
...
- Globalno: `~/.config/physicscode/commands/`
- Po projektu: `.physicscode/commands/`
...
PhysicsCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
