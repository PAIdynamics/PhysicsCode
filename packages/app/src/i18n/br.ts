export const dict = {
  ...
  "dialog.provider.physicscode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.physicscode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.physicscodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo PhysicsCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no PhysicsCode.",
  ...
  "provider.connect.physicscodeZen.line1":
    "PhysicsCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.physicscodeZen.visit.prefix": "Visite ",
  "provider.connect.physicscodeZen.visit.link": "physicscode.ai/zen",
  "provider.connect.physicscodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no PhysicsCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no PhysicsCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em physicscode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor PhysicsCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do PhysicsCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do PhysicsCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (physicscode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: PhysicsCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "PhysicsCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor PhysicsCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do PhysicsCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o PhysicsCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o PhysicsCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o PhysicsCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o PhysicsCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do PhysicsCode.",
