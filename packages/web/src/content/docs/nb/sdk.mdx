---
title: SDK
description: Typesikker JS-klient for PhysicsCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/main/packages/sdk/js/src/gen/types.gen.ts`

PhysicsCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere PhysicsCode programmatisk.
...
Opprett en forekomst av PhysicsCode:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `physicscode.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av PhysicsCode, kan du opprette en klientforekomst for å koble til den:
