...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/physicscode.git")).toEqual({ owner: "sst", repo: "physicscode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/physicscode")).toEqual({ owner: "sst", repo: "physicscode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/physicscode.git")).toEqual({ owner: "sst", repo: "physicscode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/physicscode")).toEqual({ owner: "sst", repo: "physicscode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/physicscode.git")).toEqual({ owner: "sst", repo: "physicscode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/physicscode")).toEqual({ owner: "sst", repo: "physicscode" })
})
