...
export const RootHttpApi = HttpApi.make("physicscode-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("physicscode-instance")
...
export const PhysicsCodeHttpApi = HttpApi.make("physicscode")
