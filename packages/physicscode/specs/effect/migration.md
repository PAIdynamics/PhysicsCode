...
Practical reference for new and migrated Effect code in `packages/physicscode`.
...
export class Service extends Context.Service<Service, Interface>()("@physicscode/Foo") {}
