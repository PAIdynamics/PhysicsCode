export const dict = {
  ...
  "desktop.menu.help.documentation": "PhysicsCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "PhysicsCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
