...
description: physicscode dile özgü biçimlendiriciler kullanır.
---

physicscode, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

physicscode, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, physicscode bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

physicscode bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri physicscode yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
