---
title: Özel Araçlar
description: LLM'un physicscode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. physicscode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.physicscode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/physicscode/tools/` içine yerleştirerek.
