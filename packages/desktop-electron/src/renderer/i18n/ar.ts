export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من PhysicsCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من PhysicsCode، هل ترغب في تثبيته وإعادة تشغيله؟",
