export const dict = {
  ...
  "desktop.menu.help.documentation": "PhysicsCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "PhysicsCode CLI binary is missing. Try reinstalling the desktop app.",
