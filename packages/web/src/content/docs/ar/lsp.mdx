---
title: خوادم LSP
description: يتكامل PhysicsCode مع خوادم LSP لديك.
---

يتكامل PhysicsCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي PhysicsCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `PHYSICSCODE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح physicscode ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات physicscode.
