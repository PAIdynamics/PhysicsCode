...
```jsonc title="physicscode.jsonc" {6}
{
...
```jsonc title="physicscode.jsonc" {15}
{
  "$schema": "https://physicscode.ai/config.json",
  "mcp": {
    "my-local-mcp-server": {
...
```json title="physicscode.json" {7-11}
{
  "$schema": "https://physicscode.ai/config.json",
  "mcp": {
    "my-oauth-server": {
...
```json title="physicscode.json" {14}
{
  "$schema": "https://physicscode.ai/config.json",
  "mcp": {
    "my-mcp-foo": {
...
```json title="physicscode.json" {11, 14-18}
{
  "$schema": "https://physicscode.ai/config.json",
  "mcp": {
    "my-mcp": {
...
```json title="physicscode.json" {4-8}
{
  "$schema": "https://physicscode.ai/config.json",
  "mcp": {
    "sentry": {
...
```json title="physicscode.json" {4-7}
{
  "$schema": "https://physicscode.ai/config.json",
  "mcp": {
    "context7": {
...
```json title="physicscode.json" {7-9}
{
  "$schema": "https://physicscode.ai/config.json",
  "mcp": {
    "context7": {
