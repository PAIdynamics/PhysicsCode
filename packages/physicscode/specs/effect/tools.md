...
Practical reference for the current tool-migration state in `packages/physicscode`.
...
Tool tests should use the existing Effect helpers in `packages/physicscode/test/lib/effect.ts`:
