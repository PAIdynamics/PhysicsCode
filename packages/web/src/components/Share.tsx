...
import type { MessageV2 } from "physicscode/session/message-v2"
import type { Message } from "physicscode/session/message"
import type { Session } from "physicscode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.physicscode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.physicscode_name}>
