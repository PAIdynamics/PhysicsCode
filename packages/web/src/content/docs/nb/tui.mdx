---
title: TUI
description: Bruke physicscode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PhysicsCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre PhysicsCode starter TUI for gjeldende katalog.
...
Når du bruker PhysicsCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til PhysicsCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt PhysicsCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `physicscode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `PHYSICSCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
