...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/physicscode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/physicscode...\n")
...
console.log("Fetching npm all-time downloads for physicscode-ai...\n")
const npmDownloads = await fetchNpmDownloads("physicscode-ai")
