...
beforeAll(async () => {
  ...
  mock.module("@physicscode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@physicscode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@physicscode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@physicscode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
