---
title: TUI
description: استخدام واجهة المستخدم TUI في PhysicsCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر PhysicsCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل PhysicsCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة PhysicsCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى PhysicsCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من PhysicsCode. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات PhysicsCode.
...
استخدم `PHYSICSCODE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
