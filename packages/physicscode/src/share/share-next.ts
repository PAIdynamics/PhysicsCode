import type * as SDK from "@physicscode-ai/sdk/v2"
...
const disabled = process.env["PHYSICSCODE_DISABLE_SHARE"] === "true" || process.env["PHYSICSCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@physicscode/ShareNext") {}
