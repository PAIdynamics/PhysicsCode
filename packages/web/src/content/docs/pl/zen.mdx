---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez PhysicsCode.
---
...
PhysicsCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół PhysicsCode.

:::note
PhysicsCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w PhysicsCode. Logujesz się do PhysicsCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z PhysicsCode.
:::
...
PhysicsCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

PhysicsCode Zen działa jak każdy inny dostawca w PhysicsCode.

1. Logujesz się do **<a href={console}>PhysicsCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz PhysicsCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji PhysicsCode używa formatu
`physicscode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`physicscode/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w PhysicsCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w PhysicsCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w PhysicsCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w PhysicsCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w PhysicsCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy PhysicsCode Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w PhysicsCode także dowolnego innego dostawcy.
