---
title: SDK
description: Type-safe JS client for physicscode server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/main/packages/sdk/js/src/gen/types.gen.ts`

The physicscode JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control physicscode programmatically.
...
Create an instance of physicscode:
...
You can pass a configuration object to customize behavior. The instance still picks up your `physicscode.json`, but you can override or add configuration inline:
...
If you already have a running instance of physicscode, you can create a client instance to connect to it:
