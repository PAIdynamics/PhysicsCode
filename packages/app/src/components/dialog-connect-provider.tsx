import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@physicscode-ai/sdk/v2/client"
...
import { List, type ListRef } from "@physicscode-ai/ui/list"
import { ProviderIcon } from "@physicscode-ai/ui/provider-icon"
import { Spinner } from "@physicscode-ai/ui/spinner"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "physicscode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.physicscodeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.physicscodeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.physicscodeZen.visit.prefix")}
                <Link href="https://physicscode.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.physicscodeZen.visit.link")}
                </Link>
                {language.t("provider.connect.physicscodeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
