...
import * as EffectLogger from "@physicscode-ai/core/effect/logger"
...
export class Service extends Context.Service<Service, Interface>()("@physicscode/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      if (!Flag.PHYSICSCODE_EXPERIMENTAL_PLAN_MODE) {
