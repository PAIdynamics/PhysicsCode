...
function message(providerID: ProviderID, e: APICallError) {
  return iife(() => {
    ...
    if (isPaidynamics && /Unable to connect/i.test(msg)) {
      return "Cannot connect to the PhysicsCode hosted model. Check that https://www.physicscode.ai/llm/v1 is reachable and that the Cloudflare Tunnel is running."
    }
