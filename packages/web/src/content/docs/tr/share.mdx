---
title: Paylasim
description: physicscode konusmalarini genel baglantilarla paylasin.
---

physicscode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda physicscode:
...
physicscode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak physicscode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `physicscode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda physicscode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
