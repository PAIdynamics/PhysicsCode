export const dict = {
  ...
  "dialog.provider.physicscode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.physicscode.tagline": "Reliable optimized models",
  "dialog.provider.physicscodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by PhysicsCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in PhysicsCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.physicscodeZen.line1":
    "PhysicsCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.physicscodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.physicscodeZen.visit.prefix": "Visit ",
  "provider.connect.physicscodeZen.visit.link": "physicscode.ai/zen",
  "provider.connect.physicscodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in PhysicsCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in PhysicsCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in physicscode.json",
  ...
  "dialog.server.description": "Switch which PhysicsCode server this app connects to.",
  ...
  "toast.update.description": "A new version of PhysicsCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the PhysicsCode team",
  ...
  "error.chain.checkConfig": "Check your config (physicscode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, PhysicsCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "PhysicsCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the PhysicsCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for PhysicsCode",
  ...
  "settings.general.row.appearance.description": "Customise how PhysicsCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether PhysicsCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how PhysicsCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when PhysicsCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of PhysicsCode.",
