...
- PR #10018: https://github.com/anomalyco/physicscode/pull/10018
- PR #12935: https://github.com/anomalyco/physicscode/pull/12935

## Do Not Translate (Locale Additions)

- `PhysicsCode` (preserve casing in prose; keep `physicscode` only in commands, package names, paths, or code)
- `PhysicsCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
