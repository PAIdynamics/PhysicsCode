...
import { Slug } from "@physicscode-ai/core/util/slug"
...
export class Service extends Context.Service<Service, Interface>()("@physicscode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.PHYSICSCODE_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        PHYSICSCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        PHYSICSCODE_WORKSPACE_ID: config.id,
        PHYSICSCODE_EXPERIMENTAL_WORKSPACES: "true",
