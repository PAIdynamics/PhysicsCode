...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips physicscode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-physicscode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-physicscode-directory")).toBeNull()
      expect(result.get("x-physicscode-workspace")).toBeNull()
