...
Use this folder for locale-specific translation guidance that supplements `.physicscode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/physicscode/pull/12345

## Do Not Translate (Locale Additions)

- `PhysicsCode` (preserve casing)
