...
export class Authorization extends HttpApiMiddleware.Service<Authorization>()(
  "@physicscode/ExperimentalHttpApiAuthorization",
  {
...
export class ServerAuthConfig extends ConfigService.Service<ServerAuthConfig>()(
  "@physicscode/ExperimentalHttpApiServerAuthConfig",
  {
    password: Config.string("PHYSICSCODE_SERVER_PASSWORD").pipe(Config.option),
    username: Config.string("PHYSICSCODE_SERVER_USERNAME").pipe(Config.withDefault("physicscode")),
  },
) {}
