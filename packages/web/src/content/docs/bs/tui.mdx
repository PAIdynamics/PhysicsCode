---
title: TUI
description: Korištenje korisničkog interfejsa PhysicsCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PhysicsCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje PhysicsCode pokreće TUI za trenutni direktorij.
...
Kada koristite PhysicsCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u PhysicsCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz PhysicsCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `physicscode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `PHYSICSCODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
