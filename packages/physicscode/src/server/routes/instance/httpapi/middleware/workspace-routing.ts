...
>()("@physicscode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@physicscode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.PHYSICSCODE_WORKSPACE_ID ? WorkspaceID.make(Flag.PHYSICSCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-physicscode-directory"] || currentDirectory()
}
