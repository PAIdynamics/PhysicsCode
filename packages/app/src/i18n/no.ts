...
export const dict = {
  ...
  "dialog.provider.physicscode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.physicscode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.physicscodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av PhysicsCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i PhysicsCode.",
  ...
  "provider.connect.physicscodeZen.line1":
    "PhysicsCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.physicscodeZen.visit.prefix": "Besøk ",
  "provider.connect.physicscodeZen.visit.link": "physicscode.ai/zen",
  "provider.connect.physicscodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i PhysicsCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i PhysicsCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i physicscode.json",
  ...
  "dialog.server.description": "Bytt hvilken PhysicsCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av PhysicsCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til PhysicsCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (physicscode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at PhysicsCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "PhysicsCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør PhysicsCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for PhysicsCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan PhysicsCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om PhysicsCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan PhysicsCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når PhysicsCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av PhysicsCode.",
