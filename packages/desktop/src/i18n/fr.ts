export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'PhysicsCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI PhysicsCode est manquant. Essayez de réinstaller l'application de bureau.",
