...
Utwórz `.physicscode/commands/test.md`:
...
Możesz zdefiniować polecenia w `physicscode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji physicscode:
...
- Globalnie: `~/.config/physicscode/commands/`
- Na projekt: `.physicscode/commands/`
...
physicscode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
