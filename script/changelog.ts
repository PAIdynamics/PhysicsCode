...
Generates UPCOMING_CHANGELOG.md by running the physicscode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for physicscode run (default: low)
      --quiet            Suppress physicscode command output unless it fails
