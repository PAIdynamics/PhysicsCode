---
title: SDK
description: Typsicherer JS-Client fuer den physicscode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/main/packages/sdk/js/src/gen/types.gen.ts`

Das physicscode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und physicscode programmatisch steuern.
...
Erstelle eine physicscode-Instanz:
...
`physicscode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn physicscode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
