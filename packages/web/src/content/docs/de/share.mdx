---
title: Teilen
description: Teile PhysicsCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu PhysicsCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht PhysicsCode Folgendes:
...
PhysicsCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt PhysicsCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`physicscode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du physicscode in deiner Organisation einsetzt.
