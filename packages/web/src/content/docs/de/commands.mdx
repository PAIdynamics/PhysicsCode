...
Erstellen Sie `.physicscode/commands/test.md`:

```md title=".physicscode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die PhysicsCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem PhysicsCode [config](/docs/config):

```json title="physicscode.jsonc" {4-12}
{
...
- Global: `~/.config/physicscode/commands/`
- Pro Projekt: `.physicscode/commands/`

```markdown title="~/.config/physicscode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".physicscode/commands/component.md"
---
...
```md title=".physicscode/commands/create-file.md"
---
...
```md title=".physicscode/commands/analyze-coverage.md"
---
...
```md title=".physicscode/commands/review-changes.md"
---
...
```md title=".physicscode/commands/review-component.md"
---
...
PhysicsCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
