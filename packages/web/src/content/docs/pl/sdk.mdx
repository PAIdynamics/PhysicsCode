---
title: SDK
description: Typowany klient JS dla serwera PhysicsCode.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/main/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS PhysicsCode zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli PhysicsCode.
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `physicscode.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję PhysicsCode, możesz utworzyć instancję klienta, aby się z nią połączyć:
