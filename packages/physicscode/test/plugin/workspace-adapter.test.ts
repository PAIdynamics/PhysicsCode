...
const { Flag } = await import("@physicscode-ai/core/flag/flag")
...
const experimental = Flag.PHYSICSCODE_EXPERIMENTAL_WORKSPACES
...
afterAll(() => {
  ...
  Flag.PHYSICSCODE_EXPERIMENTAL_WORKSPACES = experimental
})
