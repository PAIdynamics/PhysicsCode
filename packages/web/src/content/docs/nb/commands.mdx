...
Opprett `.physicscode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom PhysicsCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i PhysicsCode [config](/docs/config):
...
- Per prosjekt: `.physicscode/commands/`
...
PhysicsCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
