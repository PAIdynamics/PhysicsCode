---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor physicscode.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/main/packages/sdk/js/src/gen/types.gen.ts`

El SDK physicscode JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar physicscode mediante programación.
...
Cree una instancia de physicscode:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `physicscode.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de physicscode, puede crear una instancia de cliente para conectarse a ella:
