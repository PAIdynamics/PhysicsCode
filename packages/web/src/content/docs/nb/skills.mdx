...
Agentferdigheter lar PhysicsCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går physicscode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
physicscode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `physicscode.json`:
