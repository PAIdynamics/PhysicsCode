...
สร้าง `.physicscode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ PhysicsCode:
...
- ระดับผู้ใช้ (Global): `~/.config/physicscode/commands/`
- ระดับโปรเจ็กต์: `.physicscode/commands/`
...
PhysicsCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
