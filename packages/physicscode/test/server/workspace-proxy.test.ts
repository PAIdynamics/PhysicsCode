...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips physicscode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      const request = HttpServerRequest.fromWeb(
        new Request("http://localhost/test", {
          headers: {
            ...
            "x-physicscode-workspace": "ws_123",
            "x-custom": "preserved",
          },
        }),
      )
      ...
      expect(forwarded["x-physicscode-directory"]).toBeUndefined()
      expect(forwarded["x-physicscode-workspace"]).toBeUndefined()
