...
import { TooltipKeybind } from "@physicscode-ai/ui/tooltip"
import { ResizeHandle } from "@physicscode-ai/ui/resize-handle"
import { Mark } from "@physicscode-ai/ui/logo"
...
export function SessionSidePanel(props: {
  ...
  const shown = createMemo(
    () =>
      ...
      import.meta.env.VITE_PHYSICSCODE_CHANNEL !== "beta" ||
              ...
              >
                ...
                <Tabs value={activeTab()} onChange={openTab}>
                  ...
                  <Show when={activeFileTab()} keyed>
                    {(tab) => <FileTabContent tab={tab} diffs={props.diffs} />}
                  </Show>
                </Tabs>
                <DragOverlay>
