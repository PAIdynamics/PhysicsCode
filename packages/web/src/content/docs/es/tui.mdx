---
title: TUI
description: Usando la interfaz de usuario del terminal PhysicsCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PhysicsCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar PhysicsCode se inicia TUI para el directorio actual.
...
Cuando utilice PhysicsCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a PhysicsCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de PhysicsCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `physicscode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `PHYSICSCODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
