...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PHYSICSCODE_CALLER", () => {
    process.env["PHYSICSCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PHYSICSCODE_CALLER", () => {
    process.env["PHYSICSCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PHYSICSCODE_CALLER", () => {
    process.env["PHYSICSCODE_CALLER"] = "unknown"
