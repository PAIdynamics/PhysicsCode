...
import { ResizeHandle } from "@physicscode-ai/ui/resize-handle"
...
import { Session, type Message } from "@physicscode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@physicscode-ai/ui/toast"
...
import { retry } from "@physicscode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@physicscode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://physicscode.ai/desktop-feedback")}
      renderPanel={() =>
